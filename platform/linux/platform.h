...
// In Linux, signals from SIGRTMIN to SIGRTMAX (34 to 64) can be used by applications for any purpose.
// SIGRTMIN (34) is used internally by glibc, so it is used from the number +1.
